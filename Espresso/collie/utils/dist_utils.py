...
def setup_ds_engine(
    ...
    # in  /home/ecnu/echoDocker/echozhou/collie/collie/utils/dist_utils.py(570)initialize()
...
def initialize(args=None,
    ...
    if not isinstance(model, PipelineModule) and not (isinstance(model, PeftModel) and isinstance(model.get_base_model(), PipelineModule)):
        ...
        mpu = model.mpu()
        config_class = DeepSpeedConfig(config, mpu)
        # in  /home/ecnu/echoDocker/echozhou/collie/collie/utils/pipeline_engine.py(21)__init__()
