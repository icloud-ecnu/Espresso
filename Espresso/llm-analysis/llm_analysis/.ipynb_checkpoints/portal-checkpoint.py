...
def train(
    ...
    for i in range(num_stages):
        ...
        # print("i = ",i," information = ",information)
        # end = time.time()
    ...
    if not isOK:
        out_of_memory = out_of_memory / 1024 / 1024 + 100
        if breakdown:
    ...
    # print(fwd_time)
    # print(bwd_time)
    latency = cal_pipeline_time(fwd_time,bwd_time,gradient_accumulation_steps,useNew = useNew)
    # comm latency???
